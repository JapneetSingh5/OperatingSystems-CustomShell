...
void execPsHistory()
{
    for (int i = 0; i < processNo; i++)
    {
        ...
        int stopped = kill(processList[i], 0);
        if (stopped < 0)
        {
            printf("STOPPED\n");
        }
    ...
    while (1)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                else if (input[0] != '&') // foreground process needed
                {
                    wait(NULL);
                ...
                else if (input[0] == '&') // background process needed
                {
                    // printf("bg process started with id %d\n", childProcessID);
                    processList[processNo] = childProcessID;
                    // processStatus[processNo] = 1;
                }
            }
